...
assert.match(leetCodeTrainer, /leetcode-result-output/, 'LeetCode example output should use a theme-aware readable result class');
assert.match(globals, /\.lesson-level-banner/, 'theme CSS should define the lesson level banner surface');
assert.match(globals, /\.leetcode-result-output/, 'theme CSS should define the LeetCode result output surface');
